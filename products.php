...
<form method="post" action="db_querys_products.php" >
    ...
    <input type="text" name="picture_image_front" value=" <?php echo $start_data_project['picture_image_front']?>"><br>

    <label for="picture_text"> picture_text </label>
    <input type="text" name="picture_text" value=" <?php echo $start_data_project['picture_text']?>"><br>

    <label for="picture_link"> picture_link </label>
    <input type="text" name="picture_link" value=" <?php echo $start_data_project['picture_link']?>"><br>

    <label for="code_link"> code_link </label>
    <input type="text" name="code_link" value=" <?php echo $start_data_project['code_link']?>"><br>
